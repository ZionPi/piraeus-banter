...
export const ExportModal: React.FC<ExportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div
        className="w-full max-w-4xl rounded-xl border border-secondary bg-[#FEFEFE] shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
        style={{
        ...
        <div className="flex items-center justify-between border-b border-secondary/30 p-6 bg-white/50">
          <div>
            ...
            <p className="text-text-secondary">
              Finalize your video, audio, and subtitle files.
            </p>
          </div>
          <button
            onClick={onClose}
            className="p-2 rounded-full hover:bg-secondary/20 text-text-secondary hover:text-text-primary transition-colors"
          >
          ...
          <section>
            ...
            <div className="flex flex-col gap-6 rounded-lg border border-secondary/30 bg-white/50 p-6">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                {/* Resolution */}
                <div>
                  <p className="mb-3 text-sm font-bold tracking-wide text-text-secondary">
                    Resolution
                  </p>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 rounded-lg border border-secondary/30 bg-white/60 p-4">
                <span className="material-symbols-outlined text-3xl text-yellow-600 animate-spin">
                  progress_activity
                </span>
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <p className="font-bold text-text-primary">
                      Banter_Episode_04_Final.mp4
                    </p>
              ...
              <div className="flex items-center gap-4 rounded-lg border border-secondary/30 bg-white/60 p-4">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    <p className="font-bold text-text-primary">
                      Banter_Episode_03_Final.mp4
                    </p>
                    <p className="font-bold text-primary">Complete</p>
                  </div>
                  <p className="text-xs text-text-secondary">
                    1080p | High Quality | 128 MB
                  </p>
                </div>
                <button className="px-4 py-2 rounded-lg bg-primary/10 text-primary font-bold hover:bg-primary/20 transition-colors flex items-center gap-1">
